...
<head>
    ...
    <!-- Custom StyleSheet -->
    <link rel="stylesheet" href="/my-site/zimarex/assets/css/styles.css" />
    <title>404 - Zimarex | Ecommerce Webstore</title>
    <!-- fonts -->
...
<body>
    ...
    <div class="showLoader" style="height : 80vh; display: flex; flex-direction: column; justify-content: center; align-items: center; margin-top: 50px">
        <div class="img404">
            <img src="/my-site/zimarex/assets/images/404.png" style="width: 100%;"/>
        </div>
        <a href="./">
    ...
    <!-- End Footer -->
    <!-- Custom Scripts -->
    <script src="/my-site/zimarex/assets/js/products.js"></script>
    <script src="/my-site/zimarex/assets/js/slider.js"></script>
    <script src="/my-site/zimarex/assets/js/index.js"></script>
